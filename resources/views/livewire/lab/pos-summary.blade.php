<div>
    <style>
        ...
        .rounded-4, .rounded-3, .rounded-circle, .rounded-pill, .rounded {
            border-radius: 2px !important;
        }
    ...
    <div style="background-color: #f4f6f9; min-height: calc(100vh - 70px); margin: -1.5rem; padding: 1.5rem;">
        
        <!-- Page Header -->
        <div class="page-header mb-4">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="text-dark fw-bold mb-0">Bill Summary</h5>
                </div>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between p-3 mb-4 rounded shadow-sm bg-white border border-light" style="background: var(--bs-card-bg);">
                ...
                <div class="col-xl-4">
                    <div class="card border-0 shadow-sm rounded-4 mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between p-3 rounded-3 mt-3 border {{ $invoice->due_amount > 0 ? 'bg-soft-danger border-danger' : 'bg-soft-success border-success' }}">
                                <span class="fw-bold text-dark text-uppercase fs-11 align-self-center">{{ $invoice->due_amount > 0 ? 'Balance Due' : 'Status' }}</span>
                            ...
                            <!-- Edit Invoice Button -->
                            <div class="mt-4">
                                <a href="{{ route('lab.invoice.edit', $invoice->id) }}" wire:navigate class="btn btn-outline-primary w-100 py-2 fw-bold rounded-3 shadow-sm bg-white">
