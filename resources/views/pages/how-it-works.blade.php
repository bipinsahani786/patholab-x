<x-landing-layout>
    <x-slot name="title">How It Works - {{ \App\Models\SiteSetting::get('site_name', 'Patholab-X') }}</x-slot>
    ...
    <section class="pt-32 pb-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
            ...
            <h1 class="font-display text-5xl md:text-7xl font-extrabold tracking-tight mb-8">{!! str_replace('Automates', '<span class="gradient-text">Automates</span>', e(\App\Models\SiteSetting::get('how_hero_title', 'How Patholab-X Automates Your Lab'))) !!}</h1>
